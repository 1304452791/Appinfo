...
public class AppCheckController {
	...
	public String getAppInfoList(Model model, HttpSession session,
		...
		int totalCount = 0;
		try {
			totalCount = appService.getAppInfoCount(querySoftwareName,queryFlatformId, queryCategoryLevel1, queryCategoryLevel2,
					queryCategoryLevel3);
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		try {
			appInfoList = appService.getAppInfoList(querySoftwareName,queryFlatformId, queryCategoryLevel1, queryCategoryLevel2,
	...
	public List<DataDictionary> getDataDictionaryList(String typeCode) {
		...
		try {
			dataDictionaryList = dataDictionaryService.getDataDictionaryByTypeCode(typeCode);
		} catch (Exception e) {
			e.printStackTrace();
		}
